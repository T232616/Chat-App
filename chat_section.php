...
?>
<div  id="chat_content" style="height:70vh;overflow-y:auto;border-radius:30px;width:70vw;border:2px solid #fff;margin:1.3rem auto;position:relative;">
<button  id="send_button"  style="margin:auto;border-radius:50%;position:fixed;bottom:50%;right:3rem;"  type="submit" class="btn btn-outline-light"><i class="fas fa-arrow-down"></i></button>
<?php
