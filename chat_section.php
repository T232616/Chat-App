...
?>
<button id="down_button" style="margin:auto;border-radius:50%;position:fixed;bottom:40%;right:3.6%;"  type="submit" class="btn btn-outline-light"><i class="fas fa-arrow-down down_arrow"></i></button>
